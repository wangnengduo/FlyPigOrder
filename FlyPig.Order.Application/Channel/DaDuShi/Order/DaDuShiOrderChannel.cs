...
{
    public class DaDuShiOrderChannel: TmallDaDuShiOrderChannel, IDaDuShiOrderChannel
    {
        private readonly LogWriter logWriter;
        public DaDuShiOrderChannel() : this(ShopType.RenNiXing)
        {
            logWriter = new LogWriter("Tmall/Breakfast");
        }

        public DaDuShiOrderChannel(ShopType shop) : base(shop)
        {
            logWriter = new LogWriter("Tmall/Breakfast");
        }
