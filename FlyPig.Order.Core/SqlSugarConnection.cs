...
namespace FlyPig.Order.Core
{
    ...
    {
        public const string BigTree = "server =211.147.242.166; Initial Catalog = bigTree; Persist Security Info = True; User ID = webmaster2016; Password =hotel128$RD@9;";
        ...
        public const string Travelsky = "server =124.172.245.43; Initial Catalog=travelsky; Persist Security Info=True; User ID = webmaster2014; Password =JKLyui^%$;Pooling=true;Max Pool Size=40000;Min Pool Size=0;Connection Lifetime=900;";
